...
def auto_mount_personalized(lockdown: LockdownServiceProvider,path: str) -> None:
...
def auto_mount(lockdown: LockdownServiceProvider, path: str = None, xcode: str = None, version: str = None) -> None:
